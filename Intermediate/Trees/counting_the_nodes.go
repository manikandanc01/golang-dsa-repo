...
func solveCountingTheNodes(A *treeNode) int {
	return countNode(A, 0)
}

func countNode(A *treeNode, maxValue int) int {
	if A == nil {
		return 0
	}
	...
	count += countNode(A.left, maxValue)
	count += countNode(A.right, maxValue)
