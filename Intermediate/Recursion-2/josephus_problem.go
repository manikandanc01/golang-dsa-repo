...
// To understand the solution better watch this video : 	https://www.youtube.com/watch?v=Qej8V1M1e2A

func solveJosephus(A int, B int) int {
	if A == 1 {
		return 1
	}

	return (solveJosephus(A-1, B)+B-1)%A + 1
}
